    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          <a href="{{ route('employees.add') }}" class="btn btn-sm btn-neutral">New employee</a>
        </div>
      </div>
    </div>
  </div>
          ...
          <table class="table align-items-center table-flush table-striped">
            <thead class="thead-light">
              <tr>
                ...
                <th scope="col" class="sort" data-sort="employee">Employee</th>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          ...
                          <button class="dropdown-item" data-toggle="modal" data-target="{{'#confirmDelete'.$employee->id}}">Delete</button>
                        </div>
                        <!-- Confirm Delete window -->
                        <div class="modal fade" id="{{'confirmDelete'.$employee->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
