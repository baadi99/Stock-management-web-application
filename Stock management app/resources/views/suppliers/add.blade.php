      ...
      <div class="col-xl-8 order-xl-1">
        <div class="card">
          ...
          <div class="card-body">
                    ...
                    @endif
            <form action="{{ route('suppliers.store') }}" method="POST" name="form">
              @csrf
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="input-first-name" class="form-control" placeholder="First name" name="first_name" value="{{ old('first_name') }}">
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="email" id="input-email" class="form-control" placeholder="Example@example.com" name="email" value="{{ old('email') }}">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" id="input-address" class="form-control" placeholder="Address" name="address" value="{{ old('address') }}">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" id="input-phone" class="form-control" placeholder="Phone number" name="phone_number" value="{{ old('phone_number') }}">
                    </div>
                  </div>
                </div>
                <div class="row">
